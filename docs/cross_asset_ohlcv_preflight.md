# Cross-Asset OHLCV Preflight

This preflight stays read-only and only checks readiness for the cross-asset OHLCV foundation.
...
- expected asset groups are configured
...
The evidence plan remains deferred until the cross-asset OHLCV persistence contract is approved.
