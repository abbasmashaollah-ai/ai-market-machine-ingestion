# Polygon Stock Day Agg Quarantine Download Approval Record

This is a filled operator approval record for `target_gate: quarantine_download`.

Approval record ID: `polygon-stock-day-agg-quarantine-download-001`
...
Approval phrase: `APPROVE POLYGON STOCK DAY AGG QUARANTINE DOWNLOAD`
...
This approval record does not approve:
