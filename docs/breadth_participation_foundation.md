# Breadth/Participation Foundation

This document describes the dry-run foundation for the breadth/participation ingestion slice.
It is planning and documentation only.

## Scope

- breadth/participation only
...
The normalized breadth/participation record includes:
