# Flows/Positioning Foundation

This document describes the dry-run foundation for the flows/positioning ingestion slice.
It is planning and documentation only.

## Scope

- flows/positioning only
...
The normalized flows/positioning record includes:
