...
def build_volatility_report(observation, writer_result=None):
    ...
    report = {
        ...
        "vix_close": payload.get("vix_close", payload.get("vix_level")),
        "vvix_level": payload.get("vvix_level"),
        "vvix_close": payload.get("vvix_close", payload.get("vvix_level")),
        "vxn_level": payload.get("vxn_level"),
        "vxn_close": payload.get("vxn_close", payload.get("vxn_level")),
        "rvx_level": payload.get("rvx_level"),
        "rvx_close": payload.get("rvx_close", payload.get("rvx_level")),
        ...
        "volatility_stress_score": payload.get("volatility_stress_score", payload.get("composite_volatility_stress_score")),
        "volatility_regime_label": payload.get("volatility_regime_label"),
        "descriptive_volatility_state": payload.get("descriptive_volatility_state", payload.get("volatility_regime_label")),
