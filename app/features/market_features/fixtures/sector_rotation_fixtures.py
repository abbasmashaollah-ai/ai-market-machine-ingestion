"""Deterministic OHLCV fixtures for market feature bundle sector rotation."""
...
class FakeSectorRotationDataReadClient:
    def __init__(self, payload_by_symbol: dict[str, dict[str, object]]) -> None:
...
def build_sector_rotation_ohlcv_payload(symbol: str) -> dict[str, object]:
    ...
    return {
        "symbol": normalized,
        "symbol_metadata": {"symbol": normalized, "universe": "SPDR_SECTORS"},
