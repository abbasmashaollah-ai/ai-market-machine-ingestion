...
def main() -> int:
    candidates = sorted(build_earnings_calendar_source_candidates(), key=lambda item: item.priority)
    preferred_by_type = {}
    ...
    print("next_required_step=approve_the_earnings_calendar_data_contract_and_select_the_first_live_source")
    return 0
