...
def main() -> int:
    candidates = sorted(build_options_source_candidates(), key=lambda item: item.priority)
    ...
    print("next_required_step=approve_the_options_data_contract_and_select_the_first_live_source")
    return 0
