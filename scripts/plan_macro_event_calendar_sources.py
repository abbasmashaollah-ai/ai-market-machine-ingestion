...
def main() -> int:
    candidates = sorted(build_macro_event_calendar_source_candidates(), key=lambda item: item.priority)
    preferred_by_type = {}
    ...
    for candidate in candidates:
        print(
            ...
            f"event_time_handling_note={candidate.event_time_handling_note} "
    ...
    print("next_required_step=approve_the_macro_event_calendar_data_contract_and_select_the_first_live_source")
    return 0
