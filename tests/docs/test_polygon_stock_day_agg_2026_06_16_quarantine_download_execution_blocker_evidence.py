...
DOC_PATH = Path("docs/polygon_stock_day_agg_2026_06_16_quarantine_download_execution_blocker_evidence.md")


def test_polygon_stock_day_agg_2026_06_16_quarantine_download_execution_blocker_evidence_contains_required_language() -> None:
    assert DOC_PATH.exists(), "execution blocker evidence must exist"
