...
def test_bundle_contains_all_sections_and_is_json_friendly() -> None:
    ...
    assert set(bundle) >= {"observation_date", "timestamp", "prices", "breadth", "sector_rotation", "cross_asset", "liquidity_rates", "news_sentiment", "fundamentals", "flows_positioning", "warnings"}
