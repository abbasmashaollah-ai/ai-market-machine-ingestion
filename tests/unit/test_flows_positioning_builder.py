...
def test_observation_fields() -> None:
    observation = build_flows_positioning_observation(build_flows_positioning_payload_scenario("mixed_positioning"), "2026-01-15", timestamp=datetime(2026, 1, 15, 16, 0, tzinfo=timezone.utc))
