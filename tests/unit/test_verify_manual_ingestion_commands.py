...
class VerifyManualIngestionCommandsTests(unittest.TestCase):
    ...
    def test_import_verification_is_safe_without_env(self) -> None:
        ...
        self.assertIn("scripts.dry_run_event_calendar_foundation", printed)
        self.assertIn("scripts.dry_run_opex_calendar", printed)
        self.assertIn("scripts.plan_event_calendar_sources", printed)
        self.assertIn("scripts.preflight_event_calendar_operations", printed)
        self.assertIn("scripts.dry_run_volatility_index_foundation", printed)
        self.assertIn("scripts.plan_volatility_index_sources", printed)
    ...
    def test_no_vendor_calls(self) -> None:
        ...
        self.assertIn("scripts.dry_run_event_calendar_foundation", import_names)
        self.assertIn("scripts.dry_run_opex_calendar", import_names)
        self.assertIn("scripts.plan_event_calendar_sources", import_names)
        self.assertIn("scripts.preflight_event_calendar_operations", import_names)
        self.assertIn("scripts.dry_run_volatility_index_foundation", import_names)
        self.assertIn("scripts.plan_volatility_index_sources", import_names)
